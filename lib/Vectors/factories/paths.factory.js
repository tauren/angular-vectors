...
.factory('paths', function() {
  ...
  return {
    // arrowhead: 'M0,0 L0.7,2 L0,4 L2,2 Z',
    // triangle: 'M0,0 V4 L2,2 Z',
    // circle: 'M1,2 m -1,0 a1,1 0 1,0 2,0 a1,1 0 1,0 -2,0',
    // square: 'M0,1 H2 V3 H0 Z'
    arrowhead: 'M0,0 L1,5 L0,10 L10,5 Z',
    triangle: 'M0,0 V10 L10,5 Z',
    circle: 'M5,5 m-5,0 a5,5 0 1,0 10,0 a5,5 0 1,0 -10,0',
    square: 'M0,0 H10 V10 H0 Z',

    // Borrowed paths from http://codepen.io/clintonhalpin/pen/xBDqs
